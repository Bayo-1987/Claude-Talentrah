    ...
    <div className="flex max-w-[820px] flex-col gap-6">
      ...
      <div className="flex flex-col gap-2 border-t border-line pt-5">
        {!user ? (
          ...
          // SIGNED IN: /jobs already understands both ?workType= and
          // ?country= — the same two filters this page itself represents,
          // not invented ones. `country` here is a TrackedCountry ("Nigeria",
          // "South Africa", …), the exact value /jobs's own param expects.
          <>
            <Link
