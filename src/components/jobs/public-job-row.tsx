...
export function PublicJobRow({ job }: { job: Omit<Tables<"job_postings">, "description_preview" | "search_vector" | "unlisted_at" | "banner_path" | "admin_review_decision" | "admin_review_note" | "admin_review_requested_at" | "admin_reviewed_at" | "admin_reviewed_by" | "claimed_by_organization_id" | "claimed_at"> }) {
  const meta = [
    job.company_name,
    job.location,
