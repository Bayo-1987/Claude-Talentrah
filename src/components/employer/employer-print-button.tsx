...
export function EmployerPrintButton() {
  return (
    <button
      ...
      className="flex min-h-10 items-center rounded-full border-[1.5px] border-ink bg-card px-4 font-body text-[13px] font-semibold text-ink hover:border-coral hover:text-coral"
    >
      Print / Save as PDF
    </button>
  );
