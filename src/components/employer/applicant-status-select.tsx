  ...
  return (
    <div className="flex flex-col items-end gap-1">
      <select
        ...
        className="min-h-10 rounded-2xl border-[1.5px] border-ink bg-card px-2.5 font-body text-[13px] text-ink outline-none focus:border-coral disabled:opacity-60"
      >
