-- 0189 — the `draft` job status, alone.
--
-- Split from 0190 for the same Postgres reason 0055/0056 split 'removed'
...
-- use of new value"), and 0190's policies compare against 'draft' literally.
